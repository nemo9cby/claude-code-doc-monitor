...
class ReportGenerator:
    ...
    def _get_date_dir(self, report_date: date) -> Path:
    ...
    def generate_page_diff(self, diff: DiffResult, report_date: date) -> Path:
        """Generate HTML page for a single diff."""
        date_dir = self._get_date_dir(report_date)
            ...
            for month_dir in sorted(year_dir.iterdir(), reverse=True):
                ...
                for day_dir in sorted(month_dir.iterdir(), reverse=True):
                    ...
                    if index_file.exists():
                        ...
                        # Count HTML files (excluding index)
                        page_count = sum(
    ...
    def get_report_url(self, report_date: date) -> str:
