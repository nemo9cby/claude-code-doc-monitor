...
| `metadata`                 | No          | Free-form YAML map for your own key-value data, such as entitlement or catalog fields, read by your own tooling from `SKILL.md`. Don't reuse frontmatter field names such as `paths` as keys.                                                                                                                                                                                                                                                            |
